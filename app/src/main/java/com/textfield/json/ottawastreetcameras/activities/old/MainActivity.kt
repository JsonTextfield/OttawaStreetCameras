...
class MainActivity : AppCompatActivity() {
    ...
    private fun downloadJson() {
        ...
        val jsObjRequest = JsonArrayRequest(url, Response.Listener { response ->
            ...
            main_toolbar.setOnClickListener { main_listView.setSelection(0) }
    ...
    private fun setupSectionIndex() {
        ...
        for (i in 0 until cameras.size) {
            ...
            if (!index.contains(c)) {
                ...
                t.setOnClickListener { main_listView.setSelection(i) }

                main_indexHolder.addView(t)
            }
    ...
    private fun setupListView() {
        main_listView.onItemClickListener = AdapterView.OnItemClickListener { _, _, i, _ ->

            val intent = Intent(this@MainActivity, CameraActivity::class.java)
            intent.putParcelableArrayListExtra("cameras", ArrayList(Arrays.asList(myAdapter.getItem(i)!!)))
            startActivity(intent)
        }
        main_listView.itemsCanFocus = true

        main_listView.setMultiChoiceModeListener(object : AbsListView.MultiChoiceModeListener {
            override fun onItemCheckedStateChanged(actionMode: android.view.ActionMode, i: Int, l: Long, b: Boolean) {
                if (b) {
                    if (selectedCameras.size < maxCameras) {
                        ...
                        main_listView.setItemChecked(i, false)
                    }
                } else {
                    selectedCameras.remove(myAdapter.getItem(i))
                }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.sort_name -> {
                ...
                main_indexHolder.visibility = View.VISIBLE
            ...
            R.id.distance_sort -> {
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                    ...
                    main_indexHolder.visibility = View.INVISIBLE
