...
expect fun useDynamicColor(): Boolean

expect fun dynamicColorScheme(useDarkTheme: Boolean): ColorScheme?

@Composable
expect fun setStatusBarColor(useDarkTheme: Boolean)
...
fun AppTheme(
    ...
    val dynamicScheme = dynamicColorScheme(darkTheme)
    val colorScheme = when {
        dynamicColor && useDynamicColor() && dynamicScheme != null -> {
            dynamicScheme
        }
