...
import streetcams.shared.generated.resources.change_location
...
fun SelectLocationScreen(
    ...
    Scaffold(topBar = {
        TopAppBar(
            title = {
                Text(text = stringResource(Res.string.change_location))
            },
            navigationIcon = {
                IconButton(onClick = onBackPressed) {
                    Icon(painterResource(Res.drawable.round_arrow_back_24), null)
                }
            }
        )
    }) {
